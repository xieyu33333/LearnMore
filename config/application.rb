...
if File.exist?(File.expand_path("../app_config.#{Rails.env}.yml", __FILE__))
  APP_CONFIG.deep_merge!(YAML.load_file(File.expand_path("../app_config.#{Rails.env}.yml", __FILE__)))
end
