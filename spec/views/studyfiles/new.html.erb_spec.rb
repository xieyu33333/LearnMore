...
describe "studyfiles/new" do
  before(:each) do
    assign(:studyfile, stub_model(Studyfile,
      :filename => "MyString",
      :filetype => 1,
      :download_count => 1,
      :faverate_count => 1,
  ...
  it "renders new studyfile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", studyfiles_path, "post" do
